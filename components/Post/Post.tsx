...
const Post: React.FC<IPost> = (props) => {
  ...
  return (
    <section className="py-16 md:py-24 bg-white">
      <div className="container px-4 mx-auto">
        <div className="md:max-w-6xl mx-auto mb-12 text-center">
          ...
          <div className="flex items-center justify-center">
            <p className="inline-block font-medium">{user && user.name}</p>
            <span className="mx-1">•</span>
            <p className="inline-block  font-medium">
              {formatDate(props.createdAt)}
            </p>
          </div>
          <h2 className="text-blue-600 mb-4 text-3xl md:text-5xl leading-tight text-darkCoolGray-900 font-bold tracking-tighter">
            {props.title}
          </h2>
      ...
      <div className=" container md:max-w-7xl px-4 mx-auto">
        <h1>
